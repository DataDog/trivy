...
// github.com/docker/docker v27 has known security vulnerabilities.
// The 27.x branch of moby/moby contains fixes beyond v27.5.1.
// Redirect to the latest 27.x commit until transitive dependencies
// migrate to github.com/moby/moby sub-modules.
replace github.com/docker/docker => github.com/moby/moby v27.5.2-0.20250218170852-77446557b0f8+incompatible
