...
func (a bunLibraryAnalyzer) findLicenses(ctx context.Context, fsys fs.FS, lockPath string, errCallback func(filePath string, err error) error) (map[string][]string, error) {
